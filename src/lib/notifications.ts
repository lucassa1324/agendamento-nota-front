...
export async function sendAdminNotification(data: NotificationData, type: NotificationType): Promise<void> {
...
export function scheduleReminder(bookingId: string, date: string, time: string): void {
  ...
  console.log("[v0] Lembrete será enviado em:", reminderDate.toLocaleString("pt-BR"))
}
