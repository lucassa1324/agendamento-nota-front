...
const services = [
  {
    ...
    description:
      "Modelagem personalizada que valoriza seu formato de rosto e realça seu olhar.",
  ...
  },
  {
    ...
    description:
      "Técnicas de coloração para sobrancelhas mais definidas e expressivas.",
  ...
  },
  {
    ...
    description:
      "Resultado natural e duradouro com técnicas avançadas de micropigmentação.",
  ...
  },
  {
    ...
    description:
      "Fios alinhados e volumosos por até 8 semanas com tratamento de laminação.",
