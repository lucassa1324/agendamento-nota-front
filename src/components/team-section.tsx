...
const team = [
  {
    ...
    description: "Especialista em micropigmentação com mais de 10 anos de experiência.",
  },
  {
    name: "Carla Santos",
    role: "Designer de Sobrancelhas",
    image: "beauty+professional+portrait+woman",
    description: "Certificada em técnicas avançadas de design e laminação de sobrancelhas.",
  },
  {
    name: "Juliana Costa",
    role: "Especialista em Coloração",
    image: "makeup+artist+professional+portrait",
    description: "Expert em coloração e henna, com foco em resultados naturais.",
  },
]
    ...
    <section className="py-20 md:py-32">
      <div className="container mx-auto px-4">
        <div className="text-center mb-16">
          <h2 className="font-serif text-4xl md:text-5xl font-bold mb-4 text-balance">Nossa Equipe</h2>
