        ...
        return (
          ...
          >
            <div
                ...
                className={cn(
                  "w-full flex items-center justify-between px-5 py-4 transition-all duration-300 group cursor-pointer",
            ...
            {isExpanded && (
              <div className="px-3 pb-4 space-y-2 animate-in slide-in-from-top-4 duration-300">
                  ...
                  {sections[page.id]?.map((section) => {
                    ...
                    return (
                      <div
                        ...
                        className={cn(
                          "w-full flex items-center justify-between px-4 py-3 rounded-xl text-sm transition-all group relative overflow-hidden cursor-pointer",
                          isSectionActive
