...
import { getBookingsFromStorage, updateBookingStatus, type Booking, type BookingStatus } from "@/lib/booking-data"
import { sendEmailNotification, sendWhatsAppNotification } from "@/lib/notifications"
import { Trash2, Calendar, Clock, User, Mail, Phone, Download } from "lucide-react"
...
export function BookingsManager() {
  ...
  const loadBookings = () => {
    ...
    const filtered = allBookings.filter((b) => b.date >= today && b.status !== "cancelado")
                  ...
                  <div className="flex flex-col gap-4">
                    ...
                    <div className="flex items-start justify-between">
                      <div className="flex-1">
                        <Badge className={getStatusBadge(booking.status)}>{getStatusLabel(booking.status)}</Badge>
                        <h3 className="text-xl font-semibold mt-2">{booking.serviceName}</h3>
                      </div>
                    </div>
                    ...
                    <div className="flex flex-wrap items-center gap-3 pt-4 border-t">
                      ...
                      <Button variant="outline" size="sm" onClick={() => exportToGoogle(booking)}>
