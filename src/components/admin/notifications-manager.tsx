...
export function NotificationsManager() {
  ...
  return (
    <div className="space-y-6">
      <div>
        <h2 className="text-2xl font-bold mb-2">Configurações de Notificações</h2>
        <p className="text-muted-foreground">
          Configure as notificações automáticas por email e WhatsApp para você e suas clientes
        </p>
      </div>
        ...
        <CardContent className="space-y-4">
          <div>
            ...
            <Input
              ...
              className="mt-2"
            />
            <p className="text-sm text-muted-foreground mt-1">Email que receberá notificações de novos agendamentos</p>
          </div>
          ...
          <div className="flex gap-2 pt-2">
            <Button onClick={saveEmailConfig} className="bg-primary hover:bg-primary/90">
        ...
        <CardContent className="space-y-4">
          <div>
            ...
            <Input
              ...
              onChange={(e) => setWhatsappConfig({ ...whatsappConfig, adminPhone: e.target.value })}
              placeholder="5511999999999"
              className="mt-2"
            />
            <p className="text-sm text-muted-foreground mt-1">
              Telefone que receberá notificações de novos agendamentos (formato: código do país + DDD + número)
            </p>
          </div>
          ...
          <div className="flex gap-2 pt-2">
            <Button onClick={saveWhatsAppConfig} className="bg-primary hover:bg-primary/90">
              <Send className="w-4 h-4 mr-2" />
              Salvar Configurações
            </Button>
          ...
          <div className="bg-secondary/30 p-4 rounded-lg text-sm">
            <p className="font-medium mb-2">Serviços de WhatsApp Recomendados:</p>
            <ul className="list-disc list-inside space-y-1 text-muted-foreground">
      ...
      <Card className="bg-secondary/30">
        ...
        <CardContent>
          <div className="space-y-3 text-sm">
            <p className="font-medium">O sistema enviará notificações automaticamente nos seguintes casos:</p>
            <ul className="list-disc list-inside space-y-2 text-muted-foreground ml-2">
              <li>
                <span className="font-medium text-foreground">Confirmação:</span> Quando um agendamento é confirmado
              </li>
              <li>
                <span className="font-medium text-foreground">Lembrete:</span> 24 horas antes do agendamento
              </li>
              <li>
                <span className="font-medium text-foreground">Cancelamento:</span> Quando um agendamento é cancelado
              </li>
            </ul>
            <p className="text-muted-foreground pt-2">
              Tanto você quanto a cliente receberão as notificações configuradas acima.
            </p>
          </div>
        </CardContent>
      </Card>
